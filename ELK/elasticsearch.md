...
* Шаблон (template) индекса - настройки и mapping индекса, которые автоматически устанавливаются для новых индексов, совпадающих с паттерном имени индекса, определенного в шаблоне. Шаблоны индекса могут устанавливаться в Elasticsearch автоматичечески, иак происходит при исопльзовании, например, Packetbeat, Winlogonbeat.
