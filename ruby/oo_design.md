...
В ходе проектироавния лучше выделять из конкретных классов абстрактный класс, а не наоборот, так как забытая общая часть в конкретном классе не так страшна, как забытая конкретная часть в абстрактном.
#### Шаблонный метод
